        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workplaces_Zones_ZoneId",
                        column: x => x.ZoneId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZoneFeatures", x => new { x.ZoneId, x.FeatureId });
                    table.ForeignKey(
                        name: "FK_ZoneFeatures_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ZoneFeatures_Zones_ZoneId",
                        column: x => x.ZoneId,
                        principalTable: "Zones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecurringRules_Workplaces_WorkplaceId",
                        column: x => x.WorkplaceId,
                        principalTable: "Workplaces",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RecurringRules_Zones_ZoneId",
                        column: x => x.ZoneId,
                        principalTable: "Zones",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkplaceFeatures", x => new { x.WorkplaceId, x.FeatureId });
                    table.ForeignKey(
                        name: "FK_WorkplaceFeatures_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkplaceFeatures_Workplaces_WorkplaceId",
                        column: x => x.WorkplaceId,
                        principalTable: "Workplaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringRules_WorkplaceId",
                table: "RecurringRules",
                column: "WorkplaceId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringRules_ZoneId",
                table: "RecurringRules",
                column: "ZoneId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkplaceFeatures_FeatureId",
                table: "WorkplaceFeatures",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_Workplaces_ZoneId",
                table: "Workplaces",
                column: "ZoneId");

            migrationBuilder.CreateIndex(
                name: "IX_ZoneFeatures_FeatureId",
                table: "ZoneFeatures",
                column: "FeatureId");
